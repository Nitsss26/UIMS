...
const navItems: NavItem[] = [
    { label: 'Dashboard', href: '/faculty', icon: LayoutGrid, color: 'text-blue-600' },
    { label: 'My Classes', href: '/faculty/classes', icon: Users, color: 'text-sky-500' },
    { label: 'Attendance', href: '/faculty/attendance', icon: ClipboardCheck, color: 'text-purple-500' },
    { label: 'Timetable', href: '/faculty/timetable', icon: Calendar, color: 'text-rose-500' },
    { label: 'Marks Entry', href: '/faculty/marks', icon: FileText, color: 'text-amber-500' },
    { label: 'Study Materials', href: '/faculty/materials', icon: BookOpen, color: 'text-indigo-500' },
    { label: 'Leave Application', href: '/faculty/leaves', icon: FileText, color: 'text-emerald-500' },
    { label: 'Settings', href: '/faculty/settings', icon: Settings, color: 'text-slate-500' },
];
    ...
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            <div className="lg:ml-64">
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button variant="ghost" className="flex items-center gap-2">
                                        ...
                                        <div className="hidden sm:flex flex-col items-start">
                                            <span className="text-sm font-medium text-slate-700">{auth.user?.name || 'Faculty Member'}</span>
                                            <span className="text-xs text-slate-500 capitalize">{auth.role || 'Faculty'}</span>
                                        </div>
                                ...
                                <DropdownMenuContent align="end" className="w-56">
                                    ...
                                    <DropdownMenuItem asChild>
                                        <Link to="/faculty/profile" className="flex items-center gap-2 cursor-pointer">
                                            <Users className="w-4 h-4" />
                                            Profile
                                        </Link>
                                    </DropdownMenuItem>
                                    <DropdownMenuItem asChild>
                                        <Link to="/faculty/settings" className="flex items-center gap-2 cursor-pointer">
                ...
                {/* Page Content */}
                <main className="text-slate-900 font-medium">
