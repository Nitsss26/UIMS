...
const navItems: NavItem[] = [
    { label: 'Dashboard', href: '/hostel', icon: LayoutGrid, color: 'text-blue-600' },
    { label: 'Room Allocation', href: '/hostel/allocation', icon: Bed, color: 'text-sky-500' },
    { label: 'Residents List', href: '/hostel/residents', icon: Users, color: 'text-emerald-500' },
    { label: 'Attendance', href: '/hostel/attendance', icon: ClipboardCheck, color: 'text-purple-500' },
    { label: 'Mess Management', href: '/hostel/mess', icon: Utensils, color: 'text-amber-500' },
    { label: 'Maintenance Hub', href: '/hostel/maintenance', icon: Wrench, color: 'text-rose-500' },
    { label: 'Visitor Log', href: '/hostel/visitors', icon: Shield, color: 'text-indigo-500' },
    { label: 'Fee Status', href: '/hostel/fees', icon: FileText, color: 'text-emerald-600' },
    { label: 'Settings', href: '/hostel/settings', icon: Settings, color: 'text-slate-500' },
];
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button variant="ghost" className="flex items-center gap-2">
                                        ...
                                        <div className="hidden sm:flex flex-col items-start">
                                            <span className="text-sm font-medium text-slate-700">{auth.user?.name || 'Hostel Warden'}</span>
                                            <span className="text-xs text-slate-500 capitalize">{auth.role || 'Warden'}</span>
                                        </div>
                                ...
                                <DropdownMenuContent align="end" className="w-56">
                                    ...
                                    <DropdownMenuItem asChild>
                                        <Link to="/hostel/profile" className="flex items-center gap-2 cursor-pointer">
                                            <Users className="w-4 h-4" />
                                            Profile
                                        </Link>
                                    </DropdownMenuItem>
                                    <DropdownMenuItem asChild>
                                        <Link to="/hostel/settings" className="flex items-center gap-2 cursor-pointer">
