...
const navItems: NavItem[] = [
    { label: 'Dashboard', href: '/library', icon: LayoutGrid, color: 'text-blue-600' },
    { label: 'Book Catalog', href: '/library/books', icon: Library, color: 'text-sky-500' },
    { label: 'Issue/Return', href: '/library/transactions', icon: BookPlus, color: 'text-emerald-500' },
    { label: 'Member Records', href: '/library/members', icon: Users, color: 'text-purple-500' },
    { label: 'Overdue Books', href: '/library/overdue', icon: AlertCircle, color: 'text-red-500' },
    { label: 'Reports', href: '/library/reports', icon: FileText, color: 'text-slate-600' },
    { label: 'Settings', href: '/library/settings', icon: Settings, color: 'text-slate-500' },
];
    ...
    return (
        <div className="min-h-screen bg-slate-50">
            ...
            <div className="lg:ml-64">
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button variant="ghost" className="flex items-center gap-2">
                                        ...
                                        <div className="hidden sm:flex flex-col items-start">
                                            <span className="text-sm font-medium text-slate-700">{auth.user?.name || 'Librarian'}</span>
                                            <span className="text-xs text-slate-500 capitalize">{auth.role || 'Librarian'}</span>
                                        </div>
                                ...
                                <DropdownMenuContent align="end" className="w-56">
                                    ...
                                    <DropdownMenuItem asChild>
                                        <Link to="/library/profile" className="flex items-center gap-2 cursor-pointer">
                                            <Users className="w-4 h-4" />
                                            Profile
                                        </Link>
                                    </DropdownMenuItem>
                                    <DropdownMenuItem asChild>
                                        <Link to="/library/settings" className="flex items-center gap-2 cursor-pointer">
                ...
                {/* Page Content */}
                <main className="p-4 lg:p-6 text-slate-900 font-medium">
