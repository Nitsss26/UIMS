...
const navItems: NavItem[] = [
    { label: 'Dashboard', href: '/registration', icon: LayoutGrid, color: 'text-blue-600' },
    { label: 'New Admissions', href: '/registration/admissions', icon: UserPlus, color: 'text-emerald-500' },
    { label: 'Document Verification', href: '/registration/verification', icon: FileCheck, color: 'text-sky-500' },
    { label: 'Student Records', href: '/registration/students', icon: GraduationCap, color: 'text-purple-500' },
    { label: 'Transfer/Migration', href: '/registration/transfer', icon: History, color: 'text-amber-500' },
    { label: 'ID Card Management', href: '/registration/id-cards', icon: Fingerprint, color: 'text-rose-500' },
    { label: 'Reports', href: '/registration/reports', icon: FileText, color: 'text-slate-600' },
    { label: 'Settings', href: '/registration/settings', icon: Settings, color: 'text-slate-500' },
];
                    ...
                    <div className="flex items-center justify-between h-16 px-4 lg:px-6">
                        ...
                        <div className="flex items-center gap-3">
                            <Button variant="ghost" size="icon" className="relative" asChild>
                                <Link to="/registration/notifications">
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button variant="ghost" className="flex items-center gap-2">
                                        ...
                                        <div className="hidden sm:flex flex-col items-start">
                                            <span className="text-sm font-medium text-slate-700">{auth.user?.name || 'Registrar Officer'}</span>
                                            <span className="text-xs text-slate-500 capitalize">{auth.role || 'Registrar'}</span>
                                        </div>
                                ...
                                <DropdownMenuContent align="end" className="w-56">
                                    ...
                                    <DropdownMenuItem asChild>
                                        <Link to="/registration/profile" className="flex items-center gap-2 cursor-pointer">
                                            <Users className="w-4 h-4" />
                                            Profile
                                        </Link>
                                    </DropdownMenuItem>
                                    <DropdownMenuItem asChild>
                                        <Link to="/registration/settings" className="flex items-center gap-2 cursor-pointer">
