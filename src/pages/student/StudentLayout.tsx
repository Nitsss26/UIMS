...
const navItems: NavItem[] = [
    { label: 'Dashboard', href: '/student', icon: LayoutGrid, color: 'text-blue-600' },
    { label: 'My Courses', href: '/student/courses', icon: BookOpen, color: 'text-sky-500' },
    { label: 'Attendance', href: '/student/attendance', icon: ClipboardCheck, color: 'text-purple-500' },
    { label: 'Timetable', href: '/student/timetable', icon: Calendar, color: 'text-rose-500' },
    { label: 'Results', href: '/student/results', icon: Award, color: 'text-amber-500' },
    { label: 'Fees & Dues', href: '/student/fees', icon: IndianRupee, color: 'text-emerald-500' },
    { label: 'Library', href: '/student/library', icon: Library, color: 'text-cyan-500' },
    { label: 'Documents', href: '/student/documents', icon: FileText, color: 'text-slate-500' },
    { label: 'Hostel', href: '/student/hostel', icon: Bed, color: 'text-indigo-500' },
    { label: 'Settings', href: '/student/settings', icon: Settings, color: 'text-slate-400' },
];
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <DropdownMenu>
                                <DropdownMenuTrigger asChild>
                                    <Button variant="ghost" className="flex items-center gap-2">
                                        ...
                                        <div className="hidden sm:flex flex-col items-start">
                                            <span className="text-sm font-medium text-slate-700">{auth.user?.name || 'Student Name'}</span>
                                            <span className="text-xs text-slate-500 capitalize">{auth.role || 'Student'}</span>
                                        </div>
                                ...
                                <DropdownMenuContent align="end" className="w-56">
                                    ...
                                    <DropdownMenuItem asChild>
                                        <Link to="/student/settings" className="flex items-center gap-2 cursor-pointer">
