...
const navItems: NavItem[] = [
    { label: 'Dashboard', href: '/super-admin', icon: LayoutGrid, color: 'text-blue-600' },
    { label: 'Universities', href: '/super-admin/universities', icon: Building2, color: 'text-sky-500' },
    { label: 'Analytics', href: '/super-admin/analytics', icon: BarChart3, color: 'text-emerald-500' },
    { label: 'Subscriptions', href: '/super-admin/subscriptions', icon: CreditCard, color: 'text-purple-500' },
    { label: 'System Logs', href: '/super-admin/logs', icon: FileText, color: 'text-rose-500' },
    { label: 'Settings', href: '/super-admin/settings', icon: Settings, color: 'text-slate-500' },
];
                                ...
                                <DropdownMenuTrigger asChild>
                                    <Button variant="ghost" className="flex items-center gap-2">
                                        ...
                                        <div className="hidden sm:flex flex-col items-start">
                                            <span className="text-sm font-medium text-slate-700">{auth.user?.name || 'Super Admin'}</span>
                                            <span className="text-xs text-slate-500 capitalize">{auth.role || 'Super Admin'}</span>
                                        </div>
